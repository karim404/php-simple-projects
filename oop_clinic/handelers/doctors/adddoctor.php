...
<div class="d-flex align-items-center justify-content-center" >
    ...
    <form class="card p-2" style="width: 30rem; height:25rem;" action="insertdoctor.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body d-flex flex-column gap-1 justify-content-center">
            <input class="" name="doctor_name" placeholder="type doctor name">
                ...
                <div class="input-group mb-3">
                    <select class="form-select" name="doctor_major" value="" id="inputGroupSelect02">
